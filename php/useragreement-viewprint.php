        ...
        <nav class="navbar navbar-default" style="margin-bottom:0px">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <ol class="breadcrumb">
                        <li class="hidden-xs"><a href="https://one.iu.edu/collection/iu/access-management" title="Home Page"><i class="visible-xs-inline-block icon-left-open-1"></i>Access.IU</a></li>
                        <li class=""><a href="useragreement-home.php" title="Home Page"><i class="visible-xs-inline-block icon-left-open-1"></i>Acceptable Use Agreement</a></li>
                        <li class="hidden-xs">View</li>
                    </ol>
                </div>
    ...
    <div id="main-content">
        ...
        <div id="content">
            <ul id="contents">
                ...
                <li><a href="#gov">Information Governance</a></li>
                <li><a href="#classification">Information Classification</a></li>
                <li><a href="#usage">Usage Responsibilities</a></li>
                <ul>
                    <li><a href="#secure">Secure Usage</a></li>
                    <li><a href="#legal">Legal Usage</a></li>
                    <li><a href="#ethical">Ethical Usage</a></li>
                    <li><a href="#facilitative">Facilitative Usage</a></li>
                </ul>
                <li><a href="#laws">Policies and Laws</a></li>
                <li><a href="#sanctions">Sanctions</a></li>
                <li><a href="#assent">Assent</a></li>
            </ul>
            <a name="intro"></a>
            <h4> Introduction</h4>
            <p> You have been directed to this Acceptable Use Agreement for Access to Technology
                and Information Resources as a new or continuing faculty, staff, hourly, or affiliated
                employee at Indiana University. </p>
            <p> Access to Indiana University data and information, and access to IT accounts, systems,
                and applications, is based on your need for access and your assent to use that access
                appropriately. These services are integral to the operation of the university, and
                security and privacy laws and other institutional policies protect much of the information.</p>
            <p> Therefore, before you can be granted access, you must read and agree to follow these
                acceptable usage standards, and must accept responsibility to preserve the security
                and confidentiality of information that you access, in any form, including oral,
                print, or electronic formats. </p>
            <p> Read the information below carefully. It begins with an explanation of how data
                use is governed within IU, and then sets out user responsibilities. Although these
                general provisions apply to all IU information and IT accounts, systems, and applications,
                please be aware that managers of certain services or information types may require
                you to complete additional agreements and/or training. </p>
            <a href="#top" class="pull-right">↑ top</a>
            <div class="clear"> </div>
            <a name="gov"></a>
            <h4> Information Governance Explained</h4>
            <p> The university has assigned the following roles concerning data and information.</p>
            <p> <strong>Ownership:</strong> Indiana University is the owner of the university's
                institutional data and information.</p>
            <p> <strong>Data Stewards:</strong> These are senior university officials who have planning
                and policy-level stewardship responsibility for specific segments of the university's
                information resources (usually within functional areas). Data Stewards establish
                standard rules, guidelines, and profiles for information access, and also make recommendations
                and decisions about individual requests to access information. The responsibility
                for such recommendations may be delegated to a Data Manager.</p>
            <p> <strong>Data Managers:</strong> These are university officials and their employees
                who have operational-level responsibility for information management activities
                related to the access, capture, maintenance, and dissemination of data and information.</p>
            <a href="#top" class="pull-right">↑ top</a>
            <div class="clear"> </div>
            <a name="classification"></a>
            <h4> Information Classification Explained</h4>
            <p> Institutional Data is defined as a data or information element that satisfies one
                or more of the following criteria:</p>
            <ul>
                <li>it is relevant to planning, managing, operating, or auditing a major administrative
                    function of the university</li>
                <li>it is referenced or required for use by more than one organizational unit</li>
                <li>it is included in an official university administrative report; or</li>
                <li>it is used to derive an element that meets the criteria above</li>
            </ul>
            <p> Data Stewards apply the following criteria to classify institutional data and information
                into four levels:</p>
            <ul>
                <li>Public</li>
                <li>University-internal</li>
                <li>Restricted</li>
                <li>Critical</li>
            </ul>
            <p> <strong>Public data</strong> is defined as data to which little to no restrictions
                apply. The general public may be granted access to such data.</p>
            <p> <strong>University-internal data</strong> is defined as data that may be accessed
                by all eligible employees of the university, without restriction, in the conduct
                of university business. This should be the "default" classification for all data.</p>
            <p> <strong>Restricted data</strong> may not be accessed without specific authorization,
                or only selective access may be granted because of legal, ethical, or other constraints.</p>
            <p> <strong>Critical data</strong> is defined as data by which inappropriate handling
                could result in criminal or civil penalties, identity theft, personal financial
                loss, invasion of privacy, and/or unauthorized access to this type of information
                by an individual or many individuals.</p>
            <a href="#top" class="pull-right">↑ top</a>
            <div class="clear"> </div>
            <a name="usage"></a>
